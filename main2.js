document.addEventListener("DOMContentLoaded", function () {
  ...
  function yes() {
    if (counter >= 3) {
        ...
        wedate.innerText = "We are each other's valentine now 😍. I promise to put more effort in our relationship and will make you happy each day passing. I love you cutie. ❤️😘";
